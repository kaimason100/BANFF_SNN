function result = run_arc_classification_bc_full_rank6k_gpu()
%RUN_ARC_CLASSIFICATION_BC_FULL_RANK6K_GPU ARC GPU wrapper generated from Classification/train/GPU_implementation_classification_BC_full_rank6k.mlx.
...
arc_start_diary(repo_root, 'run_arc_classification_bc_full_rank6k_gpu');
arc_print_environment('run_arc_classification_bc_full_rank6k_gpu');

% GPU_implementation_classification_BC_full_rank6k.mlx
% Train the BC full-rank 6k primary-decoder classification task and save the trained network.
...
model_file = fullfile(model_dir, sprintf('classification_BC_full_rank6k_gpu_primary_seed%03d.mat', opts.seed));
...
arc_print_training_start('run_arc_classification_bc_full_rank6k_gpu', opts, model_file);
