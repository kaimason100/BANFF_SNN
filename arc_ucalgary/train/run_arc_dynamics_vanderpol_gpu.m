function result = run_arc_dynamics_vanderpol_gpu()
%RUN_ARC_DYNAMICS_VANDERPOL_GPU ARC GPU wrapper generated from dynamical_systems/train/GPU_implementation_dynamical_systems_vanderpol.mlx.
...
arc_start_diary(repo_root, 'run_arc_dynamics_vanderpol_gpu');
arc_print_environment('run_arc_dynamics_vanderpol_gpu');
...
arc_print_training_start('run_arc_dynamics_vanderpol_gpu', opts, model_file);
