...
// spsa_dynamics_time_loop_gpu_mex.cu
//
// Copied col-major dynamical-system GPU backend for SPSA loss probes.
// The SPSA MATLAB wrapper normally calls update_bias plus run_primary_eval;
// legacy gradient/readout training and diagnostic commands remain available
// in this copied source but are not the main SPSA training path.
//
// Build:
...
// ======================= gpu command MEX =======================
// Persistent fast dynamical-systems backend.
// Commands:
